...
I got into programming through video games and a simple question:
...
**[minishell](https://github.com/BigDataBrothers/MinShell)**
A functional Unix shell written in C.
Handles parsing, pipes, redirections, environment variables and signals.
`C` `Unix`

**[cub3D](https://github.com/BigDataBrothers/Cub3d)**
A raycasting engine inspired by Wolfenstein 3D, built from scratch
using only basic graphic primitives.
...
<p align="center">
  <sub>Always working on something.</sub>
</p>
